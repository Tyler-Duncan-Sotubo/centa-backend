export declare const historyTypeEnum: import("drizzle-orm/pg-core").PgEnum<["employment", "education", "certification", "promotion", "transfer", "termination"]>;
export declare const employeeHistory: import("drizzle-orm/pg-core").PgTableWithColumns<{
