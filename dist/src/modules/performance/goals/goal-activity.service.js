...
let GoalActivityService = class GoalActivityService {
    ...
    async getLatestProgressValue(goalId, companyId) {
        const [row] = await this.db
            .select({ progress: performance_goal_updates_schema_1.performanceGoalUpdates.progress })
            .from(performance_goal_updates_schema_1.performanceGoalUpdates)
            .innerJoin(performance_goals_schema_1.performanceGoals, (0, drizzle_orm_1.eq)(performance_goals_schema_1.performanceGoals.id, performance_goal_updates_schema_1.performanceGoalUpdates.goalId))
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(performance_goal_updates_schema_1.performanceGoalUpdates.goalId, goalId), (0, drizzle_orm_1.eq)(performance_goals_schema_1.performanceGoals.companyId, companyId), (0, drizzle_orm_1.eq)(performance_goals_schema_1.performanceGoals.isArchived, false)))
            .orderBy((0, drizzle_orm_1.desc)(performance_goal_updates_schema_1.performanceGoalUpdates.createdAt))
            .limit(1);
