...
const permission_seed_processor_1 = require("./permission-seed.processor");
...
exports.PermissionsModule = PermissionsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [permissions_service_1.PermissionsService, permission_seed_processor_1.PermissionSeedProcessor],
    })
], PermissionsModule);
