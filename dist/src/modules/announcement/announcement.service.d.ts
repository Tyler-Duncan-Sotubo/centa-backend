...
export declare class AnnouncementService {
    ...
    constructor(db: db, auditService: AuditService, commentService: CommentService, reactionService: ReactionService, awsService: AwsService, announcementCache: AnnouncementCacheService, cache: CacheService);
    private listKey;
    private listTwoKey;
    private oneKey;
    private createFormKey;
