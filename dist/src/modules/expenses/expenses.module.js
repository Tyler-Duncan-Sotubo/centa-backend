...
const expense_settings_module_1 = require("./settings/expense-settings.module");
...
exports.ExpensesModule = ExpensesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [expenses_service_1.ExpensesService, expense_settings_service_1.ExpensesSettingsService],
        exports: [expenses_service_1.ExpensesService],
        imports: [expense_settings_module_1.ExpenseSettingsModule],
    })
], ExpensesModule);
