...
export declare class ExpensesService {
    ...
    constructor(db: db, auditService: AuditService, awsService: AwsService, expenseSettingsService: ExpensesSettingsService, awsStorage: S3StorageService, pusher: PusherService, logger: PinoLogger, cache: CacheService);
    private listKey;
    private byEmpKey;
    private oneKey;
    private reportKey;
