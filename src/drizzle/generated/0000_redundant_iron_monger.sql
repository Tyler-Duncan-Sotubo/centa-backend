...
CREATE TYPE "public"."employee_status" AS ENUM('probation', 'active', 'on_leave', 'resigned', 'terminated', 'onboarding', 'inactive');--> statement-breakpoint
...
CREATE TYPE "public"."offer_status" AS ENUM('pending', 'accepted', 'sent', 'declined', 'expired');--> statement-breakpoint
...
ALTER TABLE "employee_termination_checklist" ADD CONSTRAINT "employee_termination_checklist_asset_id_assets_id_fk" FOREIGN KEY ("asset_id") REFERENCES "public"."assets"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "performance_appraisal_entries" ADD CONSTRAINT "performance_appraisal_entries_manager_level_id_performance_competency_levels_id_fk" FOREIGN KEY ("manager_level_id") REFERENCES "public"."performance_competency_levels"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "performance_assessments" ADD CONSTRAINT "performance_assessments_reviewee_id_employees_id_fk" FOREIGN KEY ("reviewee_id") REFERENCES "public"."employees"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "performance_feedback" ADD CONSTRAINT "performance_feedback_recipient_id_employees_id_fk" FOREIGN KEY ("recipient_id") REFERENCES "public"."employees"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "performance_role_competency_expectations" ADD CONSTRAINT "performance_role_competency_expectations_role_id_job_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "public"."job_roles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "performance_role_competency_expectations" ADD CONSTRAINT "performance_role_competency_expectations_expected_level_id_performance_competency_levels_id_fk" FOREIGN KEY ("expected_level_id") REFERENCES "public"."performance_competency_levels"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "employee_termination_checklist_session_id_idx" ON "employee_termination_checklist" USING btree ("session_id");--> statement-breakpoint
...
CREATE INDEX "termination_types_name_idx" ON "termination_types" USING btree ("name");--> statement-breakpoint
...
CREATE INDEX "performance_assessments_cycle_id_idx" ON "performance_assessments" USING btree ("cycle_id");--> statement-breakpoint
...
CREATE INDEX "idx_feedback_sender_id" ON "performance_feedback" USING btree ("sender_id");--> statement-breakpoint
...
CREATE INDEX "idx_template_questions_question_id" ON "performance_template_questions" USING btree ("question_id");--> statement-breakpoint
