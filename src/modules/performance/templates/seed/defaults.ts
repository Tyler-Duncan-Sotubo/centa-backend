...
export const competencies = [
  {
    name: 'Accountability',
    description:
      'Takes responsibility for results and follows through on commitments.',
  },
  {
    name: 'Attendance',
  ...
  },
  {
    name: 'Skills',
    description:
      'Demonstrates the technical or functional skills for the role.',
  },
  {
    name: 'Teamwork',
  ...
  },
  {
    name: 'Technical',
    description:
      'Demonstrates specific technical knowledge required for the role.',
  },
];
...
export const questions: QuestionSeed[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question:
          'How effectively does the employee develop creative solutions?',
        type: 'rating',
      },
    ],
  },
  {
    ...
    questions: [
      {
        question:
          'Does the employee take initiative in leading tasks or projects?',
        type: 'yes_no',
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        question:
          'Does the employee pursue training or learning opportunities?',
        type: 'yes_no',
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        question:
          'Does the employee demonstrate the necessary technical skills?',
        type: 'rating',
      },
      {
        question:
          'Is the employee able to troubleshoot technical issues independently?',
        type: 'yes_no',
      },
    ],
  },
